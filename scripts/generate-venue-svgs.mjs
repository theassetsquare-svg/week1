...
function generateOGThumbnails() {
  ...
  <text x="600" y="195" text-anchor="middle" font-family="'Noto Sans KR',sans-serif" font-size="28" font-weight="500" fill="${colors.primary}">${venue.region} ${colors.label} · 후기 · 분위기 · 영업시간</text>
