...
const COMMON_KR = new Set([
  ...
  '만든다', '강남에서', '조명이', '홍대의', '홍대에서', '순간', '서면', '인천부평의', '인천부평에서', '상봉동의', '서울', '상봉역', '수유에서', '수유의', '노원의', '노원에서', '강서의', '강서에서', '강북의', '강북에서', '성남의', '성남에서', '인천의', '인천에서', '수원에서', '수원의', '자연스러운', '대구에서', '대구의', '울산의', '울산에서', '경기', '북부', '부대찌개', '행복로의', '눈부신', '창원의', '창원에서', '포항의', '김해의', '김해에서', '춘천의', '춘천에서', '청주에서', '청주의', '전주의', '전주에서', '순천의', '순천에서', '목포의', '음악의',
]);
