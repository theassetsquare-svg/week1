...
const LOUNGE_HOOKS = [
  ...
  (n,r,rv) => `시끄러운 곳 말고, 대화가 되는 곳 — ${n}${iG(n)} 그렇다`,
  (n,r,rv) => `${n}에서는 음악이 아니라 대화가 주인공이다`,
  (n,r,rv) => `첫 데이트 장소 고민 끝, ${rv} ${n}${hasJongseong(n[n.length-1])?'이면':'면'} 실패 없다`,
